...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { level: @developer.level, name: @developer.name, techs: @developer.techs } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { level: @developer.level, name: @developer.name, techs: @developer.techs } }
